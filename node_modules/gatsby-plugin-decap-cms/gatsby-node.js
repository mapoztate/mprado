...
exports.onPreInit = function (_ref) {
  ...
  try {
    ...
    reporter.warn("The netlify-cms package is deprecated, please install decap-cms-app instead. You can do this by running \"npm install decap-cms-app\"");
  } catch (err) {
    // carry on
  }
  try {
    require.resolve("netlify-cms-app");
    reporter.warn("The netlify-cms-app package is deprecated, please install decap-cms-app instead. You can do this by running \"npm install decap-cms-app\"");
  } catch (err) {
    // carry on
  }
};
  ...
  var config = (0, _extends2.default)({}, gatsbyConfig, {
    ...
    stage === "develop" && new _friendlyErrorsWebpackPlugin.default({
      ...
      compilationSuccessInfo: {
        ...
        messages: ["Decap CMS is running at " + (program.https ? "https://" : "http://") + program.host + ":" + program.proxyPort + "/" + publicPathClean + "/"]
      }
    }),
