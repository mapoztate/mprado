...
function getValidHeadNodesAndAttributes(rootNode, htmlAndBodyAttributes = {
  ...
  for (const node of rootNode.childNodes) {
    ...
    const nodeName = (_node$attributes$getN = (_node$attributes = node.attributes) === null || _node$attributes === void 0 ? void 0 : (_node$attributes$getN2 = _node$attributes.getNamedItem(`data-original-tag`)) === null || _node$attributes$getN2 === void 0 ? void 0 : _node$attributes$getN2.value) !== null && _node$attributes$getN !== void 0 ? _node$attributes$getN : node.nodeName.toLowerCase();
    ...
    } else if (!node.attributes.getNamedItem(`data-gatsby-head-react-19-workaround`)) {
