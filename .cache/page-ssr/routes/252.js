...
__webpack_require__.d(__webpack_exports__, {
  tZ: () => (/* binding */ Honeypot),
  Lm: () => (/* binding */ NetlifyFormComponent),
  Ni: () => (/* binding */ NetlifyFormProvider),
  T2: () => (/* binding */ useNetlifyForm)
});

// UNUSED EXPORTS: NetlifyForm, NetlifyFormContext, Recaptcha, useNetlifyFormContext

// EXTERNAL MODULE: external "/Users/mp-adm/Documents/VSCode/mprado/node_modules/react/index.js"
var index_js_ = __webpack_require__(7757);
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return index_js_default().createElement("div", _extends({}, childProps, {
...
/* harmony default export */ const esm = ((/* unused pure expression or super */ null && (RecaptchaWrapper)));
...
function index_modern_objectWithoutPropertiesLoose(source, excluded) {
...
var NetlifyFormContext = index_js_default().createContext();
NetlifyFormContext.displayName = 'NetlifyFormContext';
var NetlifyFormProvider = function NetlifyFormProvider(_ref) {
  var children = _ref.children,
      props = index_modern_objectWithoutPropertiesLoose(_ref, _excluded);

  return /*#__PURE__*/index_js_default().createElement(NetlifyFormContext.Provider, {
    value: index_modern_extends({}, props)
  }, children);
};
function useNetlifyFormContext() {
  return index_js_default().useContext(NetlifyFormContext);
}
...
var Honeypot = function Honeypot(_ref) {
  var _ref$label = _ref.label,
      ...
      props = index_modern_objectWithoutPropertiesLoose(_ref, _excluded$1);
  ...
  return /*#__PURE__*/index_js_default().createElement("p", {
    hidden: true
  }, /*#__PURE__*/index_js_default().createElement("label", null, label, ' ', /*#__PURE__*/index_js_default().createElement("input", index_modern_extends({
    type: "text"
  }, props, {
    name: honeypotName,
...
var isEmptyChildren = function isEmptyChildren(x) {
  return index_js_default().Children.count(x) === 0;
};
    ...
    case 'CHANGE_FORM_DATA':
      {
        ...
        var name = payload.name,
            value = payload.value,
            _type = payload.type;
        return index_modern_extends({}, state, {
          values: index_modern_extends({}, state.values, (_extends2 = {}, _extends2[name] = _type !== 'checkbox' ? value : payload.checked, _extends2))
        });
      }
...
var NetlifyFormComponent = function NetlifyFormComponent(_ref) {
  var children = _ref.children,
      props = index_modern_objectWithoutPropertiesLoose(_ref, _excluded$2);
  ...
  return /*#__PURE__*/index_js_default().createElement("form", index_modern_extends({
    ref: formRef,
    method: "post",
    name: formName,
    action: formAction,
    ...
    onReset: handleReset,
    "data-netlify": true
  }, netlifyProps, props), /*#__PURE__*/index_js_default().createElement("input", {
    type: "hidden",
    name: "form-name",
    value: formName
...
var _excluded$3 = (/* unused pure expression or super */ null && (["children", "formProps"]));
var useNetlifyForm = function useNetlifyForm(_ref) {
  ...
  var _React$useReducer = index_js_default().useReducer(NetlifyFormReducer, initialState),
      state = _React$useReducer[0],
      dispatch = _React$useReducer[1];

  var formRef = index_js_default().useRef(null);
  var recaptchaRef = index_js_default().useRef(null);
  ...
  var handleSubmit = function handleSubmit(event, values) {
    ...
    try {
      ...
      var formData = index_modern_extends({
  ...
  var setHoneypotName = index_js_default().useCallback(function (ref) {
    return dispatch({
      type: 'SET_HONEYPOT_NAME',
      payload: ref
    });
  }, []);
  var enableRecaptchaHandler = index_js_default().useCallback(function (enable) {
    return dispatch({
...
var NetlifyForm = function NetlifyForm(_ref3) {
  var children = _ref3.children,
      ...
      props = index_modern_objectWithoutPropertiesLoose(_ref3, _excluded$3);
...
var _excluded$4 = (/* unused pure expression or super */ null && (["siteKey", "invisible"]));
var Recaptcha = function Recaptcha(_ref) {
  var _ref$siteKey = _ref.siteKey,
      ...
      passThroughProps = index_modern_objectWithoutPropertiesLoose(_ref, _excluded$4);

  var _useNetlifyFormContex = useNetlifyFormContext(),
      recaptchaRef = _useNetlifyFormContex.recaptchaRef;

  return /*#__PURE__*/React.createElement(GoogleRecaptcha, index_modern_extends({}, passThroughProps, {
    sitekey: siteKey,
    ref: recaptchaRef
  }, invisible ? {
    size: 'invisible'
...
/* harmony export */ });
/* unused harmony exports Controller, Form, FormProvider, FormStateSubscribe, Watch, appendErrors, createFormControl, get, set, useController, useFieldArray, useFormContext, useFormState, useWatch */
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7757);
/* provided dependency */ var fetch = __webpack_require__(3492);
